...
#==============================================================================
# COAL DEMAND
# energy_demand_init = 4000
# # energy_demand_growth_f = 0.02
# other_grey__init = 0.3
# other_grey_share_growth_f = -0.001
# green_share_init = 0.13
...
# MARKET SHARE
# market_share_init = 0.15
# market_share_added_value1 = 0
# market_share_added_value2 = 0
# market_share_base_growth_f = 0.01
# type_of_project = 'Infrastructure'

#RANGES for loops
# rangeMS_AV = np.arange(0, 0.1, 0.02)
# rangeGFMS_base = np.arange(0, 0.1, 0.025)
# ranget = np.arange(1, 41 ,1)
# rangea = np.arange(0, 0.5, 0.1)
# rangeGFE = np.arange(0, 0.05, 0.01)
# rangeu = np.arange(5,40,7)
# rangec = np.arange(0,0.5,0.1)

#==============================================================================
# run_times = 1
# coal_throughput_Rdam = None 
# data_terminals_file_name = None
# project_to_assess = None 
#==============================================================================

#==============================================================================
# discount_rate = None,
# t = None
# energy_demand_init = None
# energy_demand_growth_f = None
# c = None
# a = None
# u = None
# green_share_init = None
# other_grey__init = None
# other_grey_share_growth_f = None
# market_share_init = None
# market_share_base_growth_f = None
# type_of_project = None
# run_times = None
# project_to_assess = None
# data_terminals_current = None
# data_terminals = None
#==============================================================================


# def calculate_energy_demand(t, energy_demand_init, energy_demand_growth_f):
#     return energy_demand_init * (1 + energy_demand_growth_f) ** (t)
...
#     return other_grey_share_init * (1 + other_grey_share_growth_f) ** (t)
...
#     return market_share_init * (1 + market_share_base_growth_f)  ** (0.15 * t) 
...
#                                   self.data_terminals_current, 
#                                   self.data_terminals, 
#                                   self.new_infra_projects,
#                                   self.financial_properties,
#                                   self.port_dues,
#                                   self.land_renting_price, **experiment)
...
#==============================================================================
#     business_case_terminal_current, business_value_pora_current, data_result_current, coal_throughput_Rdam_current, market_share_Rdam_current = \
#     run_ecosystem(netlogo, data_areas, port_dues, port_dues_coal, land_renting_price, financial_properties, 
#                   t, energy_demand_init, energy_demand_growth_f, c, a, u, 
#                   green_share_init, other_grey_share_init, other_grey_share_growth_f, market_share_init, 
#                   market_share_base_growth_f, type_of_project='Current values', 
#                   run_times=run_times, data_terminals_file_name=data_terminals_file_name, 
#                   new_infra_projects=new_infra_projects)
#==============================================================================
    ...
    # TOEVOEGEN DAT DE NPV LOOPT VANAF HET STARTING YEAR VAN HET PROJECT
...
class IntegratedModel(Replicator, FileModel):
    ...
    def __init__(self, name, wd=None):
        ...
        self.netlogo_model = 'Satisficing 0409.nlogo'
        self.data_terminals_fn = 'DataTerminals - 0609.csv'
        self.data_areas = 'DataAreas - 2508.csv'
        self.data_terminals_current_fn = 'DataTerminals - current - 0609.csv'
        self.data_new_projects = 'New_projects_macro 0409.xlsm'
...
if __name__ == '__main__':
    ...
    model = IntegratedModel('Test', wd='./model')
...
#     #specify uncertainties
    ...
    #specify uncertainties
    model.uncertainties = [ RealParameter("energy_demand_growth_f",0, 0.005),
                            RealParameter("a",0,0.3),
                            RealParameter("market_share_base_growth_f", 0, 0.01),
                            IntegerParameter("u", 10,40),
                            RealParameter("c",0,0.1),
                            RealParameter("other_grey_share_growth_f", -0.01,0.01)
                          ]
                        	
                      	
    
    
#      RealParameter("other_grey_share_growth_f", 0,0.1) -> dan is coal demand negative, analyse how this is possible
    #specify outcomes 
    ...
    save_results(results, r'ResultsEcosystem3008 - test2{}.tar.gz')
